...
python main.py
```
Это удалит существующий индекс и перестроит его заново.

### Первая инициализация
При первом запуске система автоматически обработает PDF-файлы из папки `files/` и создаст векторный индекс.

### Взаимодействие
После запуска введите вопрос в консоли. Для выхода введите "exit".
...
- Ограничение ответа: около 200 токенов
